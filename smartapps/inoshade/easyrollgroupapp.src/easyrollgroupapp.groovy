...
def configurations()
{
	dynamicPage(name: "configurations", title: "Configurations", uninstall: true, nextPage: "options")
    {
        section("Device")
        {
            input "devices", "device.easyrollgroup", title: "EasyRoll(DTH)", multiple: true, required: true
            input "actions", "enum", title: "Action", multiple: false, required: true, options: ["UP", "STOP", "DOWN", "LEVEL", "M1", "M2", "M3", "AUTOLEVEL"]
        } 
        section("How")
        {
